...
(function (factory) {
  ...
  $.extend(Buttons.prototype, {
    ...
    _popover: function (content, hostButton, inOpts) {
      ...
      if (
        ...
        var listBottom =
          hostPosition.top + hostNode.outerHeight() + collectionHeight;
  ...
  var _exportData = function (dt, inOpts) {
    ...
    if (!(grouped_array_index == undefined)) {
      //don't run grouping logic if rows aren't grouped
